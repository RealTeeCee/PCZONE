                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="row col-xs-b25">
                                <div class="col-sm-6">
                                    <div class="simple-article size-5 grey">GIÁ: <span class="color">$'.$product->gia_SP.'</span></div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-sm-text-right">
                                    <div class="simple-article size-3 col-xs-b20">Tình trạng: <span class="grey">'.$inStock.'</span></div>
                                </div>
                            </div>
